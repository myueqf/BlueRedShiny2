...
#define iResolution vec3(viewWidth, viewHeight, 1.0)

// --- BlueRedShiny2 by diatribes ---
// Original: https://www.shadertoy.com/view/7cjGRR
// Ported to Minecraft by lanzhan5656
// Hope you enjoy it! ^-^
